...
export async function POST(request: NextRequest) {
  try {
    ...
    logger.info(`[Worker-483] Task ${brief.taskId}: ${brief.concept} (Model: ${brief.selectedModel})`);
    ...
    logger.info(`[Worker-483] ✅ Image generated! Quality: ${quality}/100, Time: ${totalTime}ms`);
    ...
    logger.error(`[Worker-483] ❌ Error:`, error);
