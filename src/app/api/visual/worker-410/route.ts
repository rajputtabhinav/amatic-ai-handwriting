...
export async function POST(request: NextRequest) {
  try {
    ...
    logger.info(`[Worker-410] Task ${brief.taskId}: ${brief.concept} (Model: ${brief.selectedModel})`);
    ...
    logger.info(`[Worker-410] ✅ Image generated! Quality: ${quality}/100, Time: ${totalTime}ms`);
    ...
    logger.error(`[Worker-410] ❌ Error:`, error);
