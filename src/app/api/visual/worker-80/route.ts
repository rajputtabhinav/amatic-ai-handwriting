...
export async function POST(request: NextRequest) {
  try {
    ...
    logger.info(`[Worker-80] Task ${brief.taskId}: ${brief.concept} (Model: ${brief.selectedModel})`);
    ...
    logger.info(`[Worker-80] ✅ Image generated! Quality: ${quality}/100, Time: ${totalTime}ms`);
    ...
    logger.error(`[Worker-80] ❌ Error:`, error);
