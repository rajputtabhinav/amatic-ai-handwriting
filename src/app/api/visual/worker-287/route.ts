...
export async function POST(request: NextRequest) {
  try {
    ...
    logger.info(`[Worker-287] Task ${brief.taskId}: ${brief.concept} (Model: ${brief.selectedModel})`);
    ...
    logger.info(`[Worker-287] ✅ Image generated! Quality: ${quality}/100, Time: ${totalTime}ms`);
    ...
    logger.error(`[Worker-287] ❌ Error:`, error);
