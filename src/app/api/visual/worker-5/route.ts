...
export async function POST(request: NextRequest) {
  try {
    ...
    logger.info(`[Worker-5] Task ${brief.taskId}: ${brief.concept} (Model: ${brief.selectedModel})`);
    ...
    logger.info(`[Worker-5] ✅ Image generated! Quality: ${quality}/100, Time: ${totalTime}ms`);
    ...
    logger.error(`[Worker-5] ❌ Error:`, error);
