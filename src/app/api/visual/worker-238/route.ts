...
export async function POST(request: NextRequest) {
  try {
    ...
    logger.info(`[Worker-238] Task ${brief.taskId}: ${brief.concept} (Model: ${brief.selectedModel})`);
    ...
    logger.info(`[Worker-238] ✅ Image generated! Quality: ${quality}/100, Time: ${totalTime}ms`);
    ...
    logger.error(`[Worker-238] ❌ Error:`, error);
