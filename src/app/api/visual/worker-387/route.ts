...
export async function POST(request: NextRequest) {
  try {
    ...
    logger.info(`[Worker-387] Task ${brief.taskId}: ${brief.concept} (Model: ${brief.selectedModel})`);
    ...
    logger.info(`[Worker-387] ✅ Image generated! Quality: ${quality}/100, Time: ${totalTime}ms`);
    ...
    logger.error(`[Worker-387] ❌ Error:`, error);
