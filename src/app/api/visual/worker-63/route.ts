...
export async function POST(request: NextRequest) {
  try {
    ...
    logger.info(`[Worker-63] Task ${brief.taskId}: ${brief.concept} (Model: ${brief.selectedModel})`);
    ...
    logger.info(`[Worker-63] ✅ Image generated! Quality: ${quality}/100, Time: ${totalTime}ms`);
    ...
    logger.error(`[Worker-63] ❌ Error:`, error);
