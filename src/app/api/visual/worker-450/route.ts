...
export async function POST(request: NextRequest) {
  try {
    ...
    logger.info(`[Worker-450] Task ${brief.taskId}: ${brief.concept} (Model: ${brief.selectedModel})`);
    ...
    logger.info(`[Worker-450] ✅ Image generated! Quality: ${quality}/100, Time: ${totalTime}ms`);
    ...
    logger.error(`[Worker-450] ❌ Error:`, error);
