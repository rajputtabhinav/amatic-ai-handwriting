...
export async function POST(request: NextRequest) {
  try {
    ...
    logger.info(`[Worker-102] Task ${brief.taskId}: ${brief.concept} (Model: ${brief.selectedModel})`);
    ...
    logger.info(`[Worker-102] ✅ Image generated! Quality: ${quality}/100, Time: ${totalTime}ms`);
    ...
    logger.error(`[Worker-102] ❌ Error:`, error);
