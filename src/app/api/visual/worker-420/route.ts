...
export async function POST(request: NextRequest) {
  try {
    ...
    logger.info(`[Worker-420] Task ${brief.taskId}: ${brief.concept} (Model: ${brief.selectedModel})`);
    ...
    logger.info(`[Worker-420] ✅ Image generated! Quality: ${quality}/100, Time: ${totalTime}ms`);
    ...
    logger.error(`[Worker-420] ❌ Error:`, error);
