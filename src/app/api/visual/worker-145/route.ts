...
export async function POST(request: NextRequest) {
  try {
    ...
    logger.info(`[Worker-145] Task ${brief.taskId}: ${brief.concept} (Model: ${brief.selectedModel})`);
    ...
    logger.info(`[Worker-145] ✅ Image generated! Quality: ${quality}/100, Time: ${totalTime}ms`);
    ...
    logger.error(`[Worker-145] ❌ Error:`, error);
