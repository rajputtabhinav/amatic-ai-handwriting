...
export async function POST(request: NextRequest) {
  try {
    ...
    logger.info(`[Worker-320] Task ${brief.taskId}: ${brief.concept} (Model: ${brief.selectedModel})`);
    ...
    logger.info(`[Worker-320] ✅ Image generated! Quality: ${quality}/100, Time: ${totalTime}ms`);
    ...
    logger.error(`[Worker-320] ❌ Error:`, error);
