...
export async function POST(request: NextRequest) {
  try {
    ...
    logger.info(`[Worker-213] Task ${brief.taskId}: ${brief.concept} (Model: ${brief.selectedModel})`);
    ...
    logger.info(`[Worker-213] ✅ Image generated! Quality: ${quality}/100, Time: ${totalTime}ms`);
    ...
    logger.error(`[Worker-213] ❌ Error:`, error);
