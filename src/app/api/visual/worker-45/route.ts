...
export async function POST(request: NextRequest) {
  try {
    ...
    logger.info(`[Worker-45] Task ${brief.taskId}: ${brief.concept} (Model: ${brief.selectedModel})`);
    ...
    logger.info(`[Worker-45] ✅ Image generated! Quality: ${quality}/100, Time: ${totalTime}ms`);
    ...
    logger.error(`[Worker-45] ❌ Error:`, error);
