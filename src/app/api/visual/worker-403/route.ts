...
export async function POST(request: NextRequest) {
  try {
    ...
    logger.info(`[Worker-403] Task ${brief.taskId}: ${brief.concept} (Model: ${brief.selectedModel})`);
    ...
    logger.info(`[Worker-403] ✅ Image generated! Quality: ${quality}/100, Time: ${totalTime}ms`);
    ...
    logger.error(`[Worker-403] ❌ Error:`, error);
