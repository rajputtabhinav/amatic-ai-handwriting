...
export async function POST(request: NextRequest) {
  try {
    ...
    logger.info(`[Worker-97] Task ${brief.taskId}: ${brief.concept} (Model: ${brief.selectedModel})`);
    ...
    logger.info(`[Worker-97] ✅ Image generated! Quality: ${quality}/100, Time: ${totalTime}ms`);
    ...
    logger.error(`[Worker-97] ❌ Error:`, error);
