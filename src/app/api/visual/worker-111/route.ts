...
export async function POST(request: NextRequest) {
  try {
    ...
    logger.info(`[Worker-111] Task ${brief.taskId}: ${brief.concept} (Model: ${brief.selectedModel})`);
    ...
    logger.info(`[Worker-111] ✅ Image generated! Quality: ${quality}/100, Time: ${totalTime}ms`);
    ...
    logger.error(`[Worker-111] ❌ Error:`, error);
