...
export async function POST(request: NextRequest) {
  try {
    ...
    logger.info(`[Worker-25] Task ${brief.taskId}: ${brief.concept} (Model: ${brief.selectedModel})`);
    ...
    logger.info(`[Worker-25] ✅ Image generated! Quality: ${quality}/100, Time: ${totalTime}ms`);
    ...
    logger.error(`[Worker-25] ❌ Error:`, error);
