...
export async function POST(request: NextRequest) {
  try {
    ...
    logger.info(`[Worker-415] Task ${brief.taskId}: ${brief.concept} (Model: ${brief.selectedModel})`);
    ...
    logger.info(`[Worker-415] ✅ Image generated! Quality: ${quality}/100, Time: ${totalTime}ms`);
    ...
    logger.error(`[Worker-415] ❌ Error:`, error);
